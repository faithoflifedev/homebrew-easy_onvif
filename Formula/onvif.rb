class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.1.2+11"
  sha256 "5d2e8c7c253525638409dd325fbcb13a7b4e062f5d219c840eeeaf7cf30bea72"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.1.2+11", shell_output("bin/onvif version")
  end
end