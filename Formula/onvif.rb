class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.1.0-dev.5"
  sha256 "7aa399e4144ae775a044b31626dfad94fb17348bbff73d85051167c678bde983"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.1.0-dev.5", shell_output("bin/onvif version")
  end
end