class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.1.2+8"
  sha256 "abd7c0c530f581f046bcaeb5033bd72e2949731db84aa5850bf3bfdfb0441619"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.1.2+8", shell_output("bin/onvif version")
  end
end