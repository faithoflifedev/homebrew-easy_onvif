class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.1.0-dev.16"
  sha256 "64f8af01f929d2a5379b6861afacd011ba6762822bf660c5be06527e692aca4f"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.1.0-dev.16", shell_output("bin/onvif version")
  end
end