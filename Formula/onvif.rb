class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.1.0-dev.3"
  sha256 "8d3da708dca88c4910a7567ae8e8d405c6c9955c583fddb09b1c8efe662d5c34"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.1.0-dev.3", shell_output("bin/onvif version")
  end
end