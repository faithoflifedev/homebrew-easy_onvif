class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.0.13+11"
  sha256 "0602a2091f4571a4ae062fe5b45b30fe776bd6ea697ea6dbd874087013fb0037"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.0.13+11", shell_output("bin/onvif version")
  end
end