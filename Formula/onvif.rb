class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.1.3+2"
  sha256 "4537170292ea7d4e8ca43087bfd9f40b4906dd6fb224e547f53b16c85469f247"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.1.3+2", shell_output("bin/onvif version")
  end
end