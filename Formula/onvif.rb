class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.0.13+13"
  sha256 "0255f14429988ba8e4b0d8fcfda4abb26f303ea4510023e30e3547f2d9ee60bf"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.0.13+13", shell_output("bin/onvif version")
  end
end