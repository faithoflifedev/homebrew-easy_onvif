class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.0.13+8"
  sha256 "a8ff6319f6b0cf9f1f536bd9532f569d6590647682ca21d5ffd39eda036c3849"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.0.13+8", shell_output("bin/onvif version")
  end
end