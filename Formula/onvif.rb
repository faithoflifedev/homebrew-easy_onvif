class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.1.0-dev.4"
  sha256 "fe2f67bd97f911e6ed52666962fd4478940b3d18eed910971e511fc6bb9cb447"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.1.0-dev.4", shell_output("bin/onvif version")
  end
end