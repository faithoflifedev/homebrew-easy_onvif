class Onvif < Formula
  ...
  url "https://api.github.com/repos/faithoflifedev/easy_onvif/tarball/v2.1.2+1"
  sha256 "ef25b8df9cb9a872da303eded026f0cced1dc97abd9b0ec589c1476410d98194"
  license "MIT"
  ...
  test do
    assert_match "obs_websocket v2.1.2+1", shell_output("bin/onvif version")
  end
end